...
public final class SystemEventsServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.grpc.SystemEventsRequest,
      com.example.grpc.SystemEventsResponse> getGetActionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getAction",
      requestType = com.example.grpc.SystemEventsRequest.class,
      responseType = com.example.grpc.SystemEventsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.grpc.SystemEventsRequest,
      com.example.grpc.SystemEventsResponse> getGetActionMethod() {
    io.grpc.MethodDescriptor<com.example.grpc.SystemEventsRequest, com.example.grpc.SystemEventsResponse> getGetActionMethod;
      ...
      synchronized (SystemEventsServiceGrpc.class) {
        if ((getGetActionMethod = SystemEventsServiceGrpc.getGetActionMethod) == null) {
          SystemEventsServiceGrpc.getGetActionMethod = getGetActionMethod = 
              io.grpc.MethodDescriptor.<com.example.grpc.SystemEventsRequest, com.example.grpc.SystemEventsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "SystemEventsService", "getAction"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpc.SystemEventsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpc.SystemEventsResponse.getDefaultInstance()))
  ...
  public static abstract class SystemEventsServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getAction(com.example.grpc.SystemEventsRequest request,
        io.grpc.stub.StreamObserver<com.example.grpc.SystemEventsResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.example.grpc.SystemEventsRequest,
                com.example.grpc.SystemEventsResponse>(
  ...
  public static final class SystemEventsServiceBlockingStub extends io.grpc.stub.AbstractStub<SystemEventsServiceBlockingStub> {
    ...
    /**
     */
    public com.example.grpc.SystemEventsResponse getAction(com.example.grpc.SystemEventsRequest request) {
  ...
  public static final class SystemEventsServiceFutureStub extends io.grpc.stub.AbstractStub<SystemEventsServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.grpc.SystemEventsResponse> getAction(
        com.example.grpc.SystemEventsRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_ACTION:
          serviceImpl.getAction((com.example.grpc.SystemEventsRequest) request,
              (io.grpc.stub.StreamObserver<com.example.grpc.SystemEventsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class SystemEventsServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.grpc.Events.getDescriptor();
    }
